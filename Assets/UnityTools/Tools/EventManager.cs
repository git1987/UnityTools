...
#region 无参监听事件
    ...
    public static class EventManager
    {
        ...
        /// </summary>
        /// <param name="key"></param>
        public static void Broadcast<E>(E key) where E : Enum
        {
            Broadcast($"{typeof(E).Name}.{key.ToString()}");
        }
        /// <summary>
        /// 清除所有委托
        /// </summary>
...
#region 1参数监听事件
    ...
    public static class EventManager<T>
    {
        ...
        /// <param name="key"></param>
        /// <param name="t"></param>
        public static void Broadcast<E>(E key, T t) where E : Enum
        {
            Broadcast($"{typeof(E).Name}.{key.ToString()}", t);
        }
        /// <summary>
        /// 清除所有委托
        /// </summary>
...
#region 2参数监听事件
    ...
    public static class EventManager<T1, T2>
    {
        ...
        {
            Broadcast($"{typeof(E).Name}.{key.ToString()}", t1, t2);
        }
        /// <summary>
        /// 清除所有委托
        /// </summary>
